...
Processo seletivo do Programa Warren Tech Academy!

A linguagem utilizado para resoluçao dos problemas foi escolhida em JavaScript com html + css para facilitar a demonstração.
